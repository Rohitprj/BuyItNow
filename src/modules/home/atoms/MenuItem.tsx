...
const MenuItem: FC<MenuItemProps> = ({ item, isFocused, onSelect }) => {
  return (
    ...
    >
      ...
      />
      <Text
        style={[styles.text, isFocused ? styles.textFocused : styles.unFocused]}
      >
        {item?.name}
      </Text>
    </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  icon: { width: RFValue(18), height: RFValue(18), marginVertical: 4 },
  text: { fontWeight: 'bold', fontStyle: 'italic', fontSize: RFValue(10) },
